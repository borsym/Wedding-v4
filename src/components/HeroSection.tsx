      ...
      <section>
        <div className="grid max-w-screen-xl px-4 py-28 mx-auto lg:gap-8 xl:gap-0 lg:py-44 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-normal md:text-5xl xl:text-6xl text-white">
              Where <span className="text-purple-600">dreams</span> come true
            </h1>
            <p className="max-w-2xl mb-6 font-light leading-4  lg:mb-8 md:text-lg lg:text-xl text-white">
